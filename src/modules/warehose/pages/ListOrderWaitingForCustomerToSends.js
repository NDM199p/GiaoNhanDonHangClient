...
function ListOrderWaitingForCustomerToSendsPage() {
  let dispatch = useDispatch();
  let warehoseSelector = useSelector((state) => state.warehose);

  let orders = [];

  orders = warehoseSelector.orderWaitingForCustomerToSends;
...
export default ListOrderWaitingForCustomerToSendsPage;
